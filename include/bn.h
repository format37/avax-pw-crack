...
// __device__ void BN_CTX_free(BN_CTX *c);
...
// __device__ void BN_free(BIGNUM *a);
__host__ __device__ void BN_free(BIGNUM *a) {
  // host+device stub
}
...
int BN_mod_exp_recp(BIGNUM *r, const BIGNUM *a, const BIGNUM *p,
                    const BIGNUM *m, BN_CTX *ctx);
__device__ int BN_div_recp(BIGNUM *dv, BIGNUM *rem, const BIGNUM *m,
                BN_RECP_CTX *recp, BN_CTX *ctx);
